...
# 从共享模块导入 verl 的替代实现
from internbootcamp.utils.verl_fallback import OpenAIFunctionToolSchema, rollout_trace_op
...
class BaseTool:
    ...
    async def calc_reward(self, instance_id: str, **kwargs) -> float:
        ...
        """
        # 这个函数计算的是tool reward, 结果是能传到reward manager中的. 具体使用则取决于reward manager
        return 0.0
    ...
    async def release(self, instance_id: str, **kwargs) -> bool:
        ...
        Returns:
            True if the instance was successfully released, False otherwise.
        """
        try:
